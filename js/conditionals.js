...
function add100(userNumber) {
    return(100 + parseFloat(userNumber))
}
...
var billTotal = prompt("Enter your bill total");

function calculateTotal(luckyNumber, billTotal) {
    switch (luckyNumber) {
        case 0:
            var discount = 0;
            var discountedPrice = billTotal - (billTotal * discount);
...
alert("Your luck number was " + luckyNumber + " your bill total after discount was $" + calculateTotal(luckyNumber, billTotal));
    // if (luckyNumber === 0) {
    //     alert("no discount");
    ...
    //     alert("Congratulations it's free!!!");
    // }
// }
